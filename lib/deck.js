...
export const CARDS = [
  // ── Identity ──────────────────────────────────────────────
  {
    ...
    details:
      "Every project I've shipped started as a real business problem, not a portfolio piece. Full-stack developer based in Hyderabad, Sindh, Pakistan.",
    chips: ["Full-Stack Developer", "Hyderabad, Sindh"],
  },
  {
    id: "id-deployer",
    zone: "about",
  ...
  },
  {
    ...
    details:
      "Node.js and Express.js servers, NestJS for structured apps, JWT authentication, custom middleware, and WebSockets for realtime features. I also build workflow automation with n8n and full-stack systems using MERN/PERN architectures.",
    chips: ["Node.js", "Express.js", "NestJS", "REST APIs", "JWT Authentication", "Middleware", "WebSockets", "n8n Automation", "MERN Stack", "PERN Stack"],
  },
  {
    id: "sk-db",
    zone: "skills",
  ...
  },
  {
    ...
    details:
      "Git version control, Docker containers, Nginx reverse proxies, PM2 process management, CI/CD pipelines, Cloudflare (including Tunnels) for edge delivery, and PWA packaging for installable apps.",
    chips: ["Git", "Docker", "Cloudflare", "Nginx", "PM2", "Cloudflare Tunnels", "VPS Deployment", "CI/CD", "PWA"],
  },
  ...
  },
  {
    ...
    body: "Complete institutional management system deployed and actively running at a real institution in Hyderabad.",
    details:
  ...
  },
  {
    ...
    code: "P·09",
    title: "FinSight AI",
    subtitle: "Bank Statement Intelligence Platform",
    body: "AI-powered finance platform that extracts transactions from uploaded bank statements, auto-categorizes spending, detects anomalies, and generates plain-English AI summaries.",
    details:
      "Fully automated via n8n with scheduled weekly insights and daily anomaly email alerts. Includes a custom ledger-inspired UI, multi-account support, and OpenRouter AI.",
    chips: ["Next.js", "TypeScript", "Node.js", "Express", "PostgreSQL", "OpenRouter AI", "n8n", "Recharts"],
  },
